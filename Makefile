...
deploy:
	kubectl create secret generic postgres-credentials --from-env-file=.env --dry-run=client -o yaml | kubectl apply -f -
	...
	kubectl rollout restart deployment/orders deployment/gateway
